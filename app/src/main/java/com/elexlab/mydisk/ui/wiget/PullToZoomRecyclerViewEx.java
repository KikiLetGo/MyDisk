...
public class PullToZoomRecyclerViewEx extends PullToZoomBase<RecyclerView> implements AbsListView.OnScrollListener {
    ...
    public interface OnHeadMissDistChangeListener{
        void onHeadDistChange(float missDist);
    }

    private OnHeadMissDistChangeListener onHeadMissDistChangeListener;

    public void setOnHeadMissDistChangeListener(OnHeadMissDistChangeListener onHeadMissDistChangeListener) {
        this.onHeadMissDistChangeListener = onHeadMissDistChangeListener;
    }
        ...
        mRootView.setOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (mZoomView != null && !isHideHeader() && isPullToZoomEnabled()) {
                    ...
                    if(onHeadMissDistChangeListener != null) {
                        onHeadMissDistChangeListener.onHeadDistChange(f);
                    }
                }
            }
...
//        rv.setId(android.R.id.list);
    ...
    private boolean isFirstItemVisible() {
        if (mRootView != null) {
            ...
            final RecyclerView.LayoutManager mLayoutmanager =  mRootView.getLayoutManager();
            ...
            if (null == adapter || adapter.getItemCount() == 0) {
                ...
                if (mLayoutmanager != null){
                    if(mLayoutmanager instanceof GridLayoutManager){
                        into[0] = ((GridLayoutManager)mLayoutmanager).findFirstVisibleItemPosition();
