...
package com.elexlab.mydisk.ui.wiget.arcmenu;
...
public class ArcMenu extends RelativeLayout {
    ...
    //private WaterRipplesView wrvWaterRipples;
    ...
    private void init(Context context) {
        ...
        //wrvWaterRipples = (WaterRipplesView) findViewById(R.id.wrvWaterRipples);
    ...
    public void action(){
        EasyLog.d("mWaterRipplesView,btn", "getMeasuredWidth:" + mHintView.getMeasuredWidth());
        EasyLog.d("mWaterRipplesView,btn", "getWidth:" + mHintView.getWidth());
//        int r = (GoodNightThemeStatus.mainColor&0xff0000)>>16;
//        int g = (GoodNightThemeStatus.mainColor&0x00ff00)>>8;
//        int b = (GoodNightThemeStatus.mainColor&0x0000ff);
//        wrvWaterRipples
//                .paintWidth(3)
//                .duringTime(3800)
//                .maxRadius(mHintView.getWidth() / 2 + mHintView.getWidth() / 5)
//                .minRadius(mHintView.getWidth() / 2)
//                .x((int) mHintView.getX() + mHintView.getWidth() / 2)
//                .y((int) mHintView.getY() + mHintView.getWidth() / 2)
//                .multiply(2.2f)
//                .newTime(600)
//                .refreshTime(25)
//                .beginTransparent(64)
//                .endTransparent(0)
//                .transparentTransition(128)
//                .transparentTransitionRadius(mHintView.getWidth() / 2)
//                .RGB(r, g, b)
//                .canTouch(false);
//        wrvWaterRipples.start();
    }
